  ...
  return (
    <Box>
      ...
      <Typography variant="body1" gutterBottom>
        본 개인정보 처리방침은 연봉 계산기, 연차 계산기 등 다양한 계산기 서비스
        (이하 "개키우는개발자")가 이용자의 개인정보를 어떻게 수집, 이용, 보관,
        처리하는지에 대한 사항을 규정함을 목적으로 합니다.
      </Typography>
      ...
      <Typography variant="body1" gutterBottom>
        1. 이용자가 입력한 연봉, 연차 및 기타 계산 관련 데이터는 브라우저 세션이
        종료되면 일부 데이터는 삭제될 수 있습니다.
        <br />
